...
pub struct ExchangeRate1 {
    #[prost(string, optional, tag = "1")]
    pub ctrct_id: ::std::option::Option<std::string::String>,
    #[prost(
        enumeration = "exchange_rate1::ExchangeRateType1Code",
        optional,
        tag = "2"
    )]
    pub rate_tp: ::std::option::Option<i32>,
    #[prost(string, optional, tag = "3")]
    pub unit_ccy: ::std::option::Option<std::string::String>,
    #[prost(double, optional, tag = "4")]
    pub xchg_rate: ::std::option::Option<f64>,
}
pub mod exchange_rate1 {
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
    #[repr(i32)]
...
pub struct PaymentInitiationSource1 {
    ...
    #[prost(string, optional, tag = "2")]
    pub prvdr: ::std::option::Option<std::string::String>,
    #[prost(string, optional, tag = "3")]
    pub vrsn: ::std::option::Option<std::string::String>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct GroupHeader95 {
    ...
    #[prost(message, optional, tag = "6")]
    pub initn_src: ::std::option::Option<PaymentInitiationSource1>,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CreditTransferTransaction40 {
    #[prost(message, required, tag = "1")]
    pub amt: AmountType4Choice,
    #[prost(message, optional, tag = "2")]
    pub cdtr: ::std::option::Option<PartyIdentification135>,
    #[prost(message, optional, tag = "3")]
    ...
    #[prost(
        enumeration = "credit_transfer_transaction40::ChargeBearerType1Code",
        optional,
        tag = "7"
    )]
    ...
    pub xchg_rate_inf: ::std::option::Option<ExchangeRate1>,
}
pub mod credit_transfer_transaction40 {
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
    #[repr(i32)]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct PaymentInstruction34 {
    #[prost(bool, optional, tag = "1")]
    pub btch_bookg: ::std::option::Option<bool>,
    #[prost(message, repeated, tag = "2")]
    pub cdt_trf_tx_inf: ::std::vec::Vec<CreditTransferTransaction40>,
    #[prost(
        enumeration = "payment_instruction34::ChargeBearerType1Code",
        optional,
        tag = "3"
    )]
    pub chrg_br: ::std::option::Option<i32>,
    ...
    #[prost(string, optional, tag = "11")]
    pub instr_for_dbtr_agt: ::std::option::Option<std::string::String>,
    #[prost(string, optional, tag = "12")]
    pub nb_of_txs: ::std::option::Option<std::string::String>,
    #[prost(string, required, tag = "13")]
    pub pmt_inf_id: std::string::String,
    #[prost(
        enumeration = "payment_instruction34::PaymentMethod3Code",
        required,
        tag = "14"
    )]
    pub pmt_mtd: i32,
    ...
    pub poolg_adjstmnt_dt: ::std::option::Option<i32>,
    #[prost(message, optional, tag = "17")]
    pub reqd_advc_tp: ::std::option::Option<AdviceType1>,
    #[prost(message, required, tag = "18")]
    pub reqd_exctn_dt: DateAndDateTime2Choice,
    #[prost(message, optional, tag = "19")]
    pub ultmt_dbtr: ::std::option::Option<PartyIdentification135>,
}
pub mod payment_instruction34 {
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
    #[repr(i32)]
    pub enum ChargeBearerType1Code {
        Cred = 1,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CustomerCreditTransferInitiationV10 {
    #[prost(message, required, tag = "1")]
    pub grp_hdr: GroupHeader95,
    #[prost(message, repeated, tag = "2")]
    pub pmt_inf: ::std::vec::Vec<PaymentInstruction34>,
    #[prost(message, repeated, tag = "3")]
    pub splmtry_data: ::std::vec::Vec<SupplementaryData1>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Document {
    #[prost(message, required, tag = "1")]
    pub cstmr_cdt_trf_initn: CustomerCreditTransferInitiationV10,
}
