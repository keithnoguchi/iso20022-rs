...
pub struct PaymentConditionStatus1 {
    #[prost(message, optional, tag = "1")]
    pub accptd_amt: ::std::option::Option<ActiveCurrencyAndAmount>,
...
pub struct OriginalTransactionReference33 {
    ...
    #[prost(message, optional, tag = "5")]
    pub dbtr: ::std::option::Option<PartyIdentification135>,
    #[prost(message, optional, tag = "6")]
    ...
    #[prost(
        enumeration = "original_transaction_reference33::PaymentMethod4Code",
        optional,
        tag = "11"
    )]
...
pub mod original_transaction_reference33 {
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
    #[repr(i32)]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct PaymentTransaction128 {
    ...
    pub dbtr_dcsn_dt_tm: ::std::option::Option<i64>,
    #[prost(message, repeated, tag = "6")]
    pub nclsd_file: ::std::vec::Vec<Document12>,
    #[prost(string, optional, tag = "7")]
    ...
    #[prost(message, optional, tag = "9")]
    pub orgnl_tx_ref: ::std::option::Option<OriginalTransactionReference33>,
    #[prost(string, optional, tag = "10")]
    pub orgnl_uetr: ::std::option::Option<std::string::String>,
    #[prost(message, optional, tag = "11")]
    pub pmt_cond_sts: ::std::option::Option<PaymentConditionStatus1>,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct OriginalPaymentInstruction39 {
    #[prost(message, repeated, tag = "1")]
    pub nb_of_txs_per_sts: ::std::vec::Vec<NumberOfTransactionsPerStatus5>,
    #[prost(double, optional, tag = "2")]
    pub orgnl_ctrl_sum: ::std::option::Option<f64>,
    ...
    pub sts_rsn_inf: ::std::vec::Vec<StatusReasonInformation12>,
    #[prost(message, repeated, tag = "7")]
    pub tx_inf_and_sts: ::std::vec::Vec<PaymentTransaction128>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CreditorPaymentActivationRequestStatusReportV08 {
    #[prost(message, required, tag = "1")]
    pub grp_hdr: GroupHeader87,
    #[prost(message, required, tag = "2")]
    pub orgnl_grp_inf_and_sts: OriginalGroupInformation30,
    #[prost(message, repeated, tag = "3")]
    pub orgnl_pmt_inf_and_sts: ::std::vec::Vec<OriginalPaymentInstruction39>,
    #[prost(message, repeated, tag = "4")]
    pub splmtry_data: ::std::vec::Vec<SupplementaryData1>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Document {
    #[prost(message, required, tag = "1")]
    pub cdtr_pmt_actvtn_req_sts_rpt: CreditorPaymentActivationRequestStatusReportV08,
}
